...
public class ProductResourcesTests {
	...
	public void insertShouldReturnProductDtoAndStatusCreated() throws Exception {
		...
		result.andExpect(jsonPath("$.sku").exists());
	}
	...
	@Test
	public void updateShouldReturnEntityNotFoundWhenIdDoesNotExists() throws Exception {
		String jsonBody = objectMapper.writeValueAsString(productDTO);
	...
	@Test
	public void findByIdShloudReturnNotFoundWhenIdDoesNotExists() throws Exception {
